...
public class Employee  implements java.io.Serializable {
    ...
    public Employee(int employeeId, Department department, String name, Boolean gender, Date birthday, String photo, String email, Double salary, String notes, Set<Rewardetails> rewardetailses, Set<Disciplinedetails> disciplinedetailses) {
       this.employeeId = employeeId;
       this.department = department;
       this.name = name;
       this.gender = gender;
